...
integer, parameter :: n_v=13, n_sim=10000, n_st=5000, ntot=13


real*8 :: t_v(n_sim,n_st),av_h(n_sim),var_h(n_sim),sd_h(n_sim), &
n0(n_sim),r_v(n_sim,n_st),avr_h(n_sim),sdr_h(n_sim)
...
eMu0 = -3.95d0  !Total chemical potential of the motor (mu-ep)

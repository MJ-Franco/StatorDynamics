...
subroutine KMCoop(eJ,eMu,rn0,n_v,n_sim,n_st,tv_smpl,t_smpl,ntt)
...
w(1) = 0.5d0*(1.0d0 - dtanh(-eMu/2.0d0))
w(2) = 0.5d0*(1.0d0 - dtanh(-(eJ+eMu)/2.0d0))
w(3) = 0.5d0*(1.0d0 - dtanh(-eJ-eMu/2.0d0)) 
w(4) = 0.5d0*(1.0d0 - dtanh(eJ+eMu/2.0d0))
w(5) = 0.5d0*(1.0d0 - dtanh((eJ+eMu)/2.0d0)) 
w(6) = 0.5d0*(1.0d0 - dtanh(eMu/2.0d0))
...
do j=1,n_sim 
    ...
    do i=2,ntt
      ...
      t_smpl(j,i) = t_smpl(j,i-1) + 0.08d0

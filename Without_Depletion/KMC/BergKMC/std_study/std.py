...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 30 18:11:53 2021
...
files1=['/media/luke/Elements/Simulations/Without _depletion/KMC/BergKMC/Std_study/sdt_vs_Nss_alpha=3.06.dat'] 
data1=[]
...
files2=['/media/luke/Elements/Simulations/Without _depletion/KMC/BergKMC/Std_study/sdt_vs_Nss_alpha=6.15.dat'] 
data2=[]
...
files3=['/media/luke/Elements/Simulations/Without _depletion/KMC/BergKMC/Std_study/sdt_vs_Nss_alpha=30.44.dat'] 
data3=[]
...
plt.ylabel('$<\phi>$')
plt.grid()
plt.errorbar(data[:,0],data[:,1],data[:,2],marker='s',capsize=3,linestyle='',label=r'$\alpha=3.06$')
plt.errorbar(data6[:,0],data6[:,1],data6[:,2],marker='s',capsize=3,linestyle='',label=r'$\alpha=6.15$')
plt.errorbar(data30[:,0],data30[:,1],data30[:,2],marker='s',capsize=3,linestyle='',label=r'$\alpha=30.44$')
...
def LoadExpData():
    ...
    D300 = np.load('/media/mfranco/Elements/Simulations/Data/NilsD300_V2.p',allow_pickle=True)
    D500 = np.load('/media/mfranco/Elements/Simulations/Data/NilsD500.p',allow_pickle=True)
    D1300 = np.load('/media/mfranco/Elements/Simulations/Data/NilsD1300.p',allow_pickle=True)
...
plt.title("Berg's model ($N_{max}=13$)")
plt.xlabel('$<\phi>$')
plt.ylabel('Standard deviation')
plt.grid()
plt.errorbar(data[:,1]/nmax,data[:,2]/nmax,data[:,3]/nmax,marker='s',capsize=3,linestyle='',label=r'$\alpha=3.06$')
plt.errorbar(data6[:,1]/nmax,data6[:,2]/nmax,data6[:,3]/nmax,marker='s',capsize=3,linestyle='',label=r'$\alpha=6.15$')
plt.errorbar(data30[:,1]/nmax,data30[:,2]/nmax,data30[:,3]/nmax,marker='s',capsize=3,linestyle='',label=r'$\alpha=30.44$')

plt.errorbar(SS_Res,Std_Res,Error_std_Res,Error_avg_Res,marker='^',label='Exp Res',capsize=3,linestyle='')
plt.errorbar(SS_Stall,Std_Stall,Error_std_Stall,Error_avg_Stall,marker='^',label='Exp Release',capsize=3,linestyle='')
